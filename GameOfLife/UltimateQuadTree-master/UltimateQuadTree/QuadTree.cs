...
namespace UltimateQuadTree
{
    ...
    public class QuadTree<T>
    {
        ...
        public QuadTree(ulong x, ulong y, ulong width, ulong height, IQuadTreeObjectBounds<T> objectBounds, int maxObjects = 10, int maxLevel = 5)
        {
        ...
        /// <param name="maxObjects">The max number of elements in one rectangle. The default is 10.</param>
        /// <param name="maxLevel">The max depth level. The default is 5. </param>
        public QuadTree(ulong width, ulong height, IQuadTreeObjectBounds<T> objectBounds, int maxObjects = 10, int maxLevel = 5)
